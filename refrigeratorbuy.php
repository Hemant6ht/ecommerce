...
if(isset($_GET['buy'])and isset($_SESSION['email']))
{
   $pid=$_GET['pid'];
   $quant=$_GET['quant'];
  header("location:buy.php?pid=$pid&category=refrigerator&quantity=$quant"); 
...
elseif(!isset($_SESSION['email'])and isset($_GET['buy'])){
    $pid=$_GET['pid'];
    header("location:refrigeratorbuy.php?pid=$pid&msg3=please login first to Buy");
        ...
        <div class="row">
                <div class="col-sm-12" style="margin-left: 15px; margin-right: 15px">
                  ...
                  <?php 
                      ...
                      $pid=$_GET['pid'];
                      include("connect.php");
                      $q="select * from refrigerator where pid='$pid'";
                  ...
                  <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 10px">
                                <?php if(isset($_GET['msg3']))
                                    echo $_GET['msg3'];
                                    ?>
                                <img src="./images/refrigerator/<?php echo $pid ?>.jpg" class="img-responsive">
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-7" style="padding: 5vh;display: flex;flex-direction: column;">
                              <a href="cartrefrigerator.php?pid=<?php echo $pid; ?>&category=refrigerator" style="margin-bottom: 10vh;width: 30%" class="btn btn-primary"><?php
                        if(isset($_GET['msg']))
                        {
                            echo $_GET['msg'];
                        }
                        ...
                        <input type="hidden" name="pid" value="<?php echo $pid; ?>">
                          ...
                          echo "<font color=brown size=3px >".$rowarr['compressor']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['star']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['volume']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['glass_shelves']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['stabilizer']."</font>  <br><br> ";
