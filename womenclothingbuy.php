...
if(isset($_GET['buy'])and isset($_SESSION['email']))
{
   $pid=$_GET['pid'];
   $quant=$_GET['quant'];
  header("location:buy.php?pid=$pid&category=womenclothing&quantity=$quant"); 
...
elseif(!isset($_SESSION['email'])and isset($_GET['buy'])){
    $pid=$_GET['pid'];
    header("location:womenclothingbuy.php?pid=$pid&msg3=please login first to Buy");
         ...
         <div class="row">
                <div class="col-sm-12" style="margin-left: 15px; margin-right: 15px">
                  ...
                  <?php 
                      ...
                      $pid=$_GET['pid'];
                      include("connect.php");
                      $q="select * from womenclothing where pid='$pid'";
                  ...
                  <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 10px">
                                <?php if(isset($_GET['msg3']))
                                    echo $_GET['msg3'];
                                    ?>
                                <img src="./images/womenclothing/<?php echo $pid ?>.jpg" class="img-responsive">
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-sm-12">
                          ...
                          echo "<font color=brown size=4px >".$rowarr['quality']."</font>  <br> ";
                          echo "<font color=brown size=4px >".$rowarr['material']."</font>  <br> ";
                          echo "<font color=brown size=4px >".$rowarr['fit']."</font>  <br> ";
                           echo "<font color=brown size=4px >".$rowarr['neck']."</font>  <br> ";
                           echo "<font color=brown size=4px >".$rowarr['pattern']."</font>  <br> ";
                          echo "<font color=brown size=4px >".$rowarr['style']."</font>  <br><br> ";
                    ...
                    <div class="col-sm-7" style="padding: 5vh;display: flex;flex-direction: column;">
                              <a href="cartwomwnclothing.php?pid=<?php echo $pid; ?>&category=womenclothing" style="margin-bottom: 10vh;width: 30%" class="btn btn-primary"><?php
                        if(isset($_GET['msg']))
                        {
                            echo $_GET['msg'];
                        }
                        ...
                        <input type="hidden" name="pid" value="<?php echo $pid; ?>">
                          ...
                          echo "<font color=brown size=3px >".$rowarr['quality']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['material']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['fit']."</font>  <br> ";
                           echo "<font color=brown size=3px >".$rowarr['neck']."</font>  <br> ";
                           echo "<font color=brown size=3px >".$rowarr['pattern']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['style']."</font>  <br><br> ";
