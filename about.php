...
<!-- register modal ends here -->
       <div style="background-color: lightyellow">
          <div class="row" style="padding-bottom: 10%">
            <div  class="col-sm-12" style="" align="center"> <img src="./images/au1.jpg" class="img-fluid" >
            </div>
          </div>
          <div class="row" style="padding-bottom: 10%">
            <div class="col-sm-12" style="" align="center"> <img src="./images/au2.jpg" class="img-fluid">
            </div>
          </div>
          <div class="row" style="padding-bottom: 5%">
            <div class="col-sm-12" style="" align="center"> <img src="./images/au3.jpg" class="img-fluid">
            </div>
          </div>
          <div class="row" style="padding-bottom: 5%">
            <div class="col-sm-12" style="" align="center"> <img src="./images/au4.jpg" class="img-fluid"></div>
          </div>
          <div class="row" style="padding-bottom: 5%">
            <div class="col-sm-12" style="" align="center"> <img src="./images/au5.jpg" class="img-fluid"></div>
          </div>
          <div class="row">
            <div class="col-sm-12" style="" align="center"> <img src="./images/au6.jpg" class="img-fluid"></div>
          </div>
        </div>
