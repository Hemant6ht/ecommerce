...
<!-- register modal ends here -->
     <div class="row">
                <div class="col-sm-12" style="margin-left: 15px; margin-right: 15px">
                  ...
                  ?>
                    <a href="mensgroomingbuy.php?pid=<?php echo $rowarr['pid'] ?>">
                  <div class="row" style="padding-bottom: 10px">
                      <div class="col-sm-4" align="center">
                        
                          <img src="./images/mensgrooming/<?php echo $rowarr['pid'] ?>.jpg" class="img-fluid">
                         </div> 
                      ...
                      <div class="col-sm-8" align="center">
                          ...
                          echo "<font color=brown size=4px >".$rowarr['working']."</font>  <br> <br>";
