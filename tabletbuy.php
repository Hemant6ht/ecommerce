...
if(isset($_GET['buy'])and isset($_SESSION['email']))
{
   $pid=$_GET['pid'];
   $quant=$_GET['quant'];
  header("location:buy.php?pid=$pid&category=tablet&quantity=$quant"); 
...
elseif(!isset($_SESSION['email'])and isset($_GET['buy'])){
    $pid=$_GET['pid'];
    header("location:tabletbuy.php?pid=$pid&msg3=please login first to Buy");
        ...
        <div class="row">
                <div class="col-sm-12" style="margin-left: 15px; margin-right: 15px">
                  ...
                  <?php 
                      ...
                      $pid=$_GET['pid'];
                      include("connect.php");
                      $q="select * from tablet where pid='$pid'";
                  ...
                  <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 10px">
                                <?php if(isset($_GET['msg3']))
                                    echo $_GET['msg3'];
                                    ?>
                                <img src="./images/tablet/<?php echo $pid ?>.jpg" class="img-responsive">
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-sm-12">
                          ...
                          echo "<font color=brown size=3px >".$rowarr['processor']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['size']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['software']."</font>  <br><br> ";
                    ...
                    <div class="col-sm-7" style="padding: 5vh;display: flex;flex-direction: column;">
                              <a href="carttablet.php?pid=<?php echo $pid; ?>&category=tablet" style="margin-bottom: 10vh;width: 30%" class="btn btn-primary"><?php
                        if(isset($_GET['msg']))
                        {
                            echo $_GET['msg'];
                        }
