...
if(isset($_GET['buy'])and isset($_SESSION['email']))
{
   $pid=$_GET['pid'];
   $quant=$_GET['quant'];
  header("location:buy.php?pid=$pid&category=ac&quantity=$quant"); 
...
elseif(!isset($_SESSION['email'])and isset($_GET['buy'])){
    $pid=$_GET['pid'];
    header("location:acbuy.php?pid=$pid&msg3=please login first to Buy");
        ...
        <div class="row">
                <div class="col-sm-12" style="margin-left: 15px; margin-right: 15px">
                  ...
                  <?php 
                      ...
                      $pid=$_GET['pid'];
                      include("connect.php");
                      $q="select * from ac where pid='$pid'";
                  ...
                  <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 10px">
                                <?php if(isset($_GET['msg3']))
                                    echo $_GET['msg3'];
                                    ?>
                                <img src="./images/ac/<?php echo $pid ?>.jpg" class="img-responsive">
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-sm-12">
                          ...
                          echo "<font color=brown size=4px >".$rowarr['condendser']."</font>  <br> ";
                          echo "<font color=brown size=4px >".$rowarr['power']."</font>  <br> ";
                          echo "<font color=brown size=4px >".$rowarr['noise_level']."</font>  <br> ";
             
                          echo "<font color=brown size=4px >".$rowarr['refrigerant']."</font>  <br><br> ";
                    ...
                    <div class="col-sm-7" style="padding: 5vh;display: flex;flex-direction: column;">
                              <a href="cartac.php?pid=<?php echo $pid; ?>&category=ac" style="margin-bottom: 10vh;width: 30%" class="btn btn-primary"><?php
                        if(isset($_GET['msg']))
                        {
                            echo $_GET['msg'];
                        }
                        ...
                        <input type="hidden" name="pid" value="<?php echo $pid; ?>">
                          ...
                          echo "<font color=brown size=3px >".$rowarr['condendser']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['power']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['noise_level']."</font>  <br> ";
             
                          echo "<font color=brown size=3px >".$rowarr['refrigerant']."</font>  <br><br> ";
