...
if(isset($_GET['buy'])and isset($_SESSION['email']))
{
   $pid=$_GET['pid'];
   $quant=$_GET['quant'];
  header("location:buy.php?pid=$pid&category=laptop&quantity=$quant"); 
...
elseif(!isset($_SESSION['email'])and isset($_GET['buy'])){
    $pid=$_GET['pid'];
    header("location:laptopbuy.php?pid=$pid&msg3=please login first to Buy");
        ...
        <div class="row">
                <div class="col-sm-12" style="margin-left: 15px; margin-right: 15px">
                  ...
                  <?php 
                      ...
                      $pid=$_GET['pid'];
                      include("connect.php");
                      $q="select * from laptop where pid='$pid'";
                  ...
                  ?>
                  <div class="row">
                    <div class="col-sm-4 bg-info" style="padding: 5vh 5vw;">
                        <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 10px">
                                <?php if(isset($_GET['msg3']))
                                    echo $_GET['msg3'];
                                    ?>
                                <img src="./images/laptop/<?php echo $pid ?>.jpg" class="img-responsive">
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-sm-12">
                          ...
                          echo "<font color=brown size=4px >".$rowarr['software']."</font>  <br> ";
                          echo "<font color=brown size=4px >".$rowarr['size']."</font>  <br> ";
                    ...
                    <div class="col-sm-7" style="padding: 5vh;display: flex;flex-direction: column;">
                              <a href="cartlaptop.php?pid=<?php echo $pid; ?>&category=laptop" style="margin-bottom: 10vh;width: 30%" class="btn btn-primary"><?php
                        if(isset($_GET['msg']))
                        {
                            echo $_GET['msg'];
                        }
                        ...
                        <input type="hidden" name="pid" value="<?php echo $pid; ?>">
                          ...
                          echo "<font color=brown size=3px >".$rowarr['software']."</font>  <br> ";
                          echo "<font color=brown size=3px >".$rowarr['size']."</font>  <br> ";
